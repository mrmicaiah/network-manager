...
-- =============================================================================
-- Tables for the guided contact review flow where Bethany presents unsorted
-- contacts with suggestions and users respond via SMS or web interface.
-- =============================================================================
...
-- reviewed = 1 once user has seen and acted on the suggestion.
-- ---------------------------------------------------------------------------
